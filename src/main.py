                        ...
                        controls=[ft.Column(controls=[
                            ft.Container(
                                ...
                                content=ft.Column(controls=[
                                    ...
                                    ft.Text(value="If you want to support the project, you can do so by leaving a tip via Buy Me a Coffee or GitHub Sponsors.", size=15, color=ft.Colors.INVERSE_SURFACE),
                            ...
                            ft.Container(
                                ...
                                content=ft.Column(controls=[
                                    ...
                                    ft.Row(wrap=True,alignment="center", controls=ft.Row(wrap=True,tight=True, controls=[
                                        ft.Button(margin=ft.Margin.only(top=10), content=ft.Text(value="QuickeR-Web"), icon=ft.Image(src="github-white-icon.webp", color=ft.Colors.SURFACE, width=20, height=20), on_click=lambda e: asyncio.ensure_future(open_url("https://github.com/ChoiceZero/QuickeR", "BLANK")), style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=12), padding=10, bgcolor=ft.Colors.PRIMARY, color=ft.Colors.SURFACE, overlay_color=ft.Colors.ON_PRIMARY_CONTAINER)),
